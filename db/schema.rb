...
ActiveRecord::Schema[7.1].define(version: 2025_10_22_004806) do
  ...
  create_table "exams", force: :cascade do |t|
    ...
    t.text "comp1_justification"
    t.text "comp2_justification"
    t.text "comp3_justification"
    t.text "comp4_justification"
    t.text "comp5_justification"
